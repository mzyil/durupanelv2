...
<!-- Display özelliği none durumda oldugu için index görünmeyecektir -->
        ...
        <div class="main_container" id="dashboard_page" style="display: none;">
            <div class="row-fluid">
                        ...
                        <div class="widget-tasks-statistics">
                            <div class="userstats clearfix" style="margin-top: 25px;">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="<?=admin_asset_url('img/avatars/07.jpg')?>" class="image">
                                    <div class="widget">
                            ...
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="<?=admin_asset_url('img/avatars/08.jpg')?>" class="image">
                                    <div class="widget">
                            ...
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="<?=admin_asset_url('img/avatars/09.jpg')?>" class="image">
                                    <div class="widget">
                            ...
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="<?=admin_asset_url('img/avatars/10.jpg')?>" class="image">
                                    <div class="widget">
                            ...
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="<?=admin_asset_url('img/avatars/11.jpg')?>" class="image">
                                    <div class="widget">
                            ...
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="<?=admin_asset_url('img/avatars/12.jpg')?>" class="image">
                                    <div class="widget">
                            ...
                            <ul>
                                <li class="priority-high">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/02.jpg')?>" class="avatar"/>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/03.jpg')?>" class="avatar"/>
                                        <h5>Login</h5>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/04.jpg')?>" class="avatar"/>
                                        <h5>Problem</h5>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/01.jpg')?>" class="avatar"/>
                                        <h5>Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Monday</div>
                                    </a>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/13.jpg')?>" class="avatar"/>
                                        <h5>A Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Monday</div>
                                    </a>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/12.jpg')?>" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/08.jpg')?>" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Yesterday</div>
                                    </a>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/10.jpg')?>" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Yesterday</div>
                                    </a>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="<?=admin_asset_url('img/avatars/11.jpg')?>" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Yesterday</div>
                                    </a>
                    ...
                    <div class="widget-body" style="height:310px;overflow:hidden">
                        <div class="widget-comments clearfix slimscroll">
                            <ul>
                                ...
                                <li>
                                    <img src="<?=admin_asset_url('img/avatars/05.jpg')?>" class="avatar"/>
                                    <div class="comment-bubble">
                                ...
                                <li>
                                    <img src="<?=admin_asset_url('img/avatars/06.jpg')?>" class="avatar"/>
                                    <div class="comment-bubble">
                                ...
                                <li>
                                    <img src="<?=admin_asset_url('img/avatars/07.jpg')?>" class="avatar"/>
                                    <div class="comment-bubble">
                                        <h4>Bill Feenhound - <strong>Bill98</strong></h4>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna ligula, mattis...
                                        <div class="date">Sunday</div>
            ...
            <div class="row-fluid">
                <div class="widget span6">
                    z<div class="widget-header"><i class="icon-signal"></i><h5>Bar Chart</h5>
                        <div class="widget-buttons">
                            <a href="javascript:void(0)" class="collapse" data-collapsed="false"><i data-title="Collapse" class="icon-chevron-up"></i></a>
                        </div>
                    </div>
...
<!-- Mirrored from www.bluthemes.com/themes/realm/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Apr 2017 17:42:50 GMT -->
</html>
